...
export default function AllElectricMeterDataTable({elmeterProp}){
    ...
    <>
            ...
            <TableRow>
              ...
              <TableCell>{elmeterProp.electric_meter_data.activepowerl1}</TableCell>
              <TableCell>{elmeterProp.electric_meter_data.activepowerl2}</TableCell>
              <TableCell>{elmeterProp.electric_meter_data.activepowerl3}</TableCell>
            ...
            <TableRow>
              ...
              <TableCell>{elmeterProp.electric_meter_data.totalActivePpower}</TableCell>
              <TableCell>Total Active Energy: </TableCell>
              <TableCell>{elmeterProp.electric_meter_data.totalActiveEnergyImportTariff1}</TableCell>
            </TableRow>
            <TableRow>
